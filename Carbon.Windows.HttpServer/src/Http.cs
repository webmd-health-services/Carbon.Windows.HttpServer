...
namespace Carbon.Windows.HttpServer
{
	...
	public sealed class HttpsCertificateBinding
	{
		...
		public HttpsCertificateBinding(
		...
		{
			var binding = obj as HttpsCertificateBinding;
		...
		public static HttpsCertificateBinding[] GetHttpsCertificateBindings()
		{
			...
			try
			{
				var bindings = new List<HttpsCertificateBinding>();
				...
				while (true)
				{
					...
					if (Win32ErrorCodes.Ok == retVal)
					{
						...
						var binding = new HttpsCertificateBinding(ipAddress, port, certificateHash, appID, storeName,
